...
export default function EstimatorClient({
  ...
  const handleAddressSelect = async (
    ...
    if (result.success && parseFloat(result.totalSquares || "0") > 0) {
      ...
      setShowLeadForm(true); // FIXED: Intercept and fire the squeeze form
    } else {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      {estimate && showLeadForm && (
        <div className="max-w-2xl mx-auto">
          <LeadCaptureSqueeze
            projectType="Roof" // FIXED: Fixed mapping from Kitchen to Roof
            aiSpecs={estimate} // FIXED: Fixed variable tracking from specs to estimate
